            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    <div class="hero-7-content hero-12-content text-center">
                        <h1 class="title" style="font-size:50px; color: #000;">Brand Identity Services in Mumbai</h1>
                        <div class="text">
                            <p style="color: #000;">At Memoire, crafting distinctive brand identities. From logo design to brand guidelines, we help you build a strong visual presence that resonates. Our expertise lies in creating brands that not only look good but also perform well. Let's elevate your brand together.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8 order-2 order-lg-1">
                        <div class="key-feature-content">
                            ...
                            <div class="text">Our brand strategy services set your business apart by uncovering opportunities through consumer and competitor analysis, crafting an authentic brand story, and establishing impactful brand positioning. We develop a unique brand voice for consistent, engaging communication and define core brand values that build trust and guide every decision.</div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8 order-1 order-lg-2">
                       <div class="key-feature-content">
                            ...
                            <div class="text">Business collateral builds a cohesive, professional brand presence. From business cards to catalogs, we design every element to reflect your values, engage your audience, and leave a lasting impression.</div><br>
