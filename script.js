var s = document.createElement('preloader.css');
...
setTimeout(function() {
  s.textContent = 'body::before { opacity: 0; transition: opacity 1s ease-in-out; }';
}, 7000); // Close after 3 seconds (adjust as needed)
