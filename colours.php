                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="portfolio-details-top-title mt-30">
                                    <h3 style="font-size:40px;" class="title">Colours Multispeciality Hospital</h3>
                                </div>
                            </div>
                   ...
                   <div class="portfolio-details-category">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="portfolio-details-category-thumb mt-30">
                                    <img src="img/colours/2.webp" alt="" style="width:80%;">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="portfolio-details-top-text mt-30">
                                    <p class="title" style="font-size:15px;line-height: 20px;">
                                        ...
                                        Colours Hospitals isn't just another hospital. Partnering with Memoire Agency, they've cultivated a brand that reflects their unique approach to pediatric care: a comforting haven that prioritizes both cutting-edge medicine and a nurturing touch. <br><br>

                                        Memoire played a key role in sculpting Colours Hospitals' brand identity, starting with their logo. The calming blue and vibrant yellow hues evoke trust and cheerfulness, while the rainbow spectrum signifies a child-friendly and inclusive environment. It's a visual representation of their commitment to holistic pediatric care.<br><br>

                                        Memoire's marketing strategies further amplify this message. They've positioned Colours Hospitals as a pediatric haven, merging top-tier medical expertise with a nurturing atmosphere. Through their campaigns, families seeking quality care for their children see Colours Hospitals' dedication to innovative treatments and a supportive environment. <br><br>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="portfolio-details-thumb-1">
                                    <img src="img/colours/4.webp" alt="" style="border: 1px solid; border-radius: 30px;"><br><br>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="portfolio-details-thumb-2">
                                    <img src="img/colours/2.webp" alt="" style="border: 1px solid; border-radius: 30px;"><br><br>
                    ...
                    <div class="portfolio-details-thumb">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="portfolio-details-thumb-1">
                                    <img src="img/colours/5.webp" alt="" style="width:100%; border: 1px solid; border-radius: 30px; height: 570px;"><br><br>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="portfolio-details-thumb-2">
                                    <img src="img/colours/7.webp" alt="" style="border: 1px solid; border-radius: 30px;">
                                    <!-- <a class="video-popup" href="https://www.youtube.com/watch?v=UFTc0wl26TY"><i class="fas fa-play"></i></a> -->
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="portfolio-details-thumb">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="portfolio-details-thumb-1">
                                    <img src="img/colours/1.webp" alt="" style="width:100%; border: 1px solid; border-radius: 30px; height: 570px;"><br><br>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="portfolio-details-thumb-2">
