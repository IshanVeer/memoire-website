            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    <div class="hero-7-content hero-12-content text-center">
                        <h1 class="title" style="font-size:50px; color: #000;">Website Design</h1>
                        <div class="text">
                            <p style="color: #000;">We specialize in creating user-friendly, visually stunning websites that deliver an exceptional experience. Our expert team focuses on intuitive design, seamless navigation, and responsive layouts to ensure your website works beautifully on any device. Whether you need a custom website, an online store, or a complete redesign, we’re here to bring your vision to life. Get in touch today to create a website that stands out!</p>
                        </div>
                    </div>
                </div>
            </div>
