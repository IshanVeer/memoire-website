...
// Add CSS rules for the scrollbar in the style element
style.innerHTML = `
  ...
  body::-webkit-scrollbar-track {
    background-color: #f4f4f4;
    box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.2); /* Slight shadow for depth */
    border-radius: 10px; /* Rounded corners for the track */
  }

  body::-webkit-scrollbar-thumb {
    background-color: #F26722; /* Vibrant thumb color */
    border-radius: 15px; /* More rounded thumb */
    border: 5px solid #f4f4f4; /* Adding space between track and thumb */
    box-shadow: inset 0 0 10px rgba(0, 0, 0, 0.4); /* 3D effect for thumb */
  }

  body::-webkit-scrollbar-thumb:hover {
    background-color: #d94f1a; /* Darker shade on hover */
  }

  /* Firefox custom scrollbar */
  html {
    scrollbar-width: thick; /* Increased width */
    scrollbar-color: #F26722 #f4f4f4;
  }
`;
